...
namespace ORB_SLAM3 {
    ...
    public:
         ...
         */
        Settings(const std::string &configFile, const int& sensor, const CameraInfo &parameters);
    ...
    private:
        ...
        void readCamera1(cv::FileStorage& fSettings, const CameraInfo &parameters);
        void readCamera2(cv::FileStorage& fSettings, const CameraInfo &parameters);
        void readImageInfo(cv::FileStorage& fSettings, const CameraInfo &parameters);
